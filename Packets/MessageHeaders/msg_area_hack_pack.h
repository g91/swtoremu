...
namespace swtorMeters
{
    ...
    class AreaHackPackDetail : public BasicSerializable <uint32_t, uint32_t, uint32_t, uint32_t>
    {
        public:
    ...
    class AreaHackPack : public BasicSerializable <uint32_t, uint32_t, CheckedFrame <uint32_t, BasicArray <54, AreaHackPackDetail>>>
    {
        public:
            using Details = std::array <AreaHackPackDetail, 54>;
            ACCESSOR_1(0, uint32_t, MessageID)
            ACCESSOR_1(1, uint32_t, StreamID)
            ACCESSOR_1(2, Details, HackData)
    };
};
