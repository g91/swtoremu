...
namespace GomLib.ModelLoader
{
    public class MapNoteLoader
    {
        ...
        private static StringTable taxiTerminals;

        static Dictionary<ulong, Models.MapNote> idMap = new Dictionary<ulong, Models.MapNote>();
        static Dictionary<string, Models.MapNote> nameMap = new Dictionary<string, Models.MapNote>();
