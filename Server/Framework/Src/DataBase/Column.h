...
namespace SimpleDB {
   ...
   */
  class DECLDIR StringColumn : public Column {
  public:
   ...
   */
  class DECLDIR BigintColumn : public Column {
  public:
    std::ostream& oStream(std::ostream& oStream);
   ...
   */
  class DECLDIR IntColumn : public Column {
  public:
   ...
   */
  class DECLDIR LongColumn : public Column {
  public:
    std::ostream& oStream(std::ostream& oStream);
   ...
   */
  class DECLDIR BoolColumn : public Column {
  public:
    std::ostream& oStream(std::ostream& oStream);
