...
namespace System.IO
{
	...
	public class EndianBinaryReader : IDisposable
	{
        ...
        /// <summary>
        /// Determines if the stream has been fully read.
        /// </summary>
        ...
        /// <summary>
        /// Returns the count of remaining bytes in the stream.
        /// </summary>
        ...
        /// <summary>
        /// Determines if the given count can be readen from the stream.
        /// </summary>
        /// <param name="count">Count to be readen.</param>
        public Boolean CanRead(Int64 count)
        {
		...
		public string ReadString(Boolean sw = false, Boolean nullt = true)
		{
            if (sw)
            {
                ReadInternal(buffer, 4);
                var bytesToRead = bitConverter.ToInt32(buffer, 0);
                if (nullt)
                {
                    var data = new byte[bytesToRead - 1];

                    ReadInternal(data, bytesToRead - 1);
                    ReadByte();
