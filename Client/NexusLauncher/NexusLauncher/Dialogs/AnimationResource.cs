        ...
        internal SafeModuleHandle LoadLibrary()
        {
            ...
            if( handle.IsInvalid )
            {
                ...
                if( error == NativeMethods.ErrorFileNotFound )
                    throw new FileNotFoundException(string.Format(System.Globalization.CultureInfo.CurrentCulture, NexusLauncher.Properties.Resources.FileNotFoundFormat, ResourceFile));
                else
