...
namespace Ookii.Dialogs.Wpf
{
    ...
    public partial class ProgressDialog : Component
    {
        ...
        public void ReportProgress(int percentProgress, string text, string description, object userState)
        {
            ...
            if( _dialog == null )
                throw new InvalidOperationException(NexusLauncher.Properties.Resources.ProgressDialogNotRunningError);
        ...
        private void RunProgressDialog(IntPtr owner, object argument)
        {
            if( _backgroundWorker.IsBusy )
                throw new InvalidOperationException(NexusLauncher.Properties.Resources.ProgressDialogRunning);
            ...
            if( Animation != null )
            {
                ...
                {
                    throw new InvalidOperationException(string.Format(System.Globalization.CultureInfo.CurrentCulture, NexusLauncher.Properties.Resources.AnimationLoadErrorFormat, ex.Message), ex);
                }
