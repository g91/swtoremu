    ...
    public partial class CredentialDialog : Component
    {
        ...
        public bool ShowDialog(Window owner)
        {
            if( string.IsNullOrEmpty(_target) )
                throw new InvalidOperationException(NexusLauncher.Properties.Resources.CredentialEmptyTargetError);
        ...
        public void ConfirmCredentials(bool confirm)
        {
            if( _confirmTarget == null || _confirmTarget != Target )
                throw new InvalidOperationException(NexusLauncher.Properties.Resources.CredentialPromptNotCalled);
        ...
        public static void StoreCredential(string target, NetworkCredential credential)
        {
            ...
            if( target.Length == 0 )
                throw new ArgumentException(NexusLauncher.Properties.Resources.CredentialEmptyTargetError, "target");
            if( credential == null )
